...
class DateFilter(django_filters.FilterSet):
    ...
    end = django_filters.DateTimeFilter(field_name="created_at", method="filter_end")

    def __init__(self, start_field="created_at", end_field="created_at", **kwargs):
        super().__init__(**kwargs)
        self.start = django_filters.DateTimeFilter(
            field_name=start_field, lookup_expr="gte"
        )
        self.end = django_filters.DateTimeFilter(field_name=end_field, method="filter_end")
